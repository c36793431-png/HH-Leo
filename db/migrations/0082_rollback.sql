...
-- Reverts exactly the 8 rows that migration inserts, and resets the counter to its
-- pre-migration baseline. Does not touch the 4 pre-existing pairs (seq 1, 2, 6, 12).
...
where provider_user_id = '94529d89-ae75-4df5-a15f-1f8a004509d1'
  and subscriber_user_id in (
    '94529d89-ae75-4df5-a15f-1f8a004509d1',
