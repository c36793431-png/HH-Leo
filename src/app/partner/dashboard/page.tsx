 ...
 * partner-dashboard.html) — top-nav amber shell now lives in dashboard/layout.tsx, this
 * renders the hero, referral link, 3 KPI cards, and the deals list/empty-state the mockup
 * specs. The mockup also specs a "next-payout schedule strip" and a "referral activity
 * funnel" (clicks -> signups -> converted) as coxwell-optional additions to cut without
 * backend data — neither has one (no payout-cadence system, no click/attribution tracking
 * table), so both are omitted here. */
