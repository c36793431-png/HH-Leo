      ...
      <div className="fa-wrap">
        <nav className="fa-nav">
          ...
          <a className="fa-nav-apply" href="/providers/apply">
            <svg className="ic" viewBox="0 0 48 48" fill="none" aria-hidden="true">
              <g stroke="currentColor" strokeWidth={4.2} strokeLinecap="round">
                <line x1="16" y1="13" x2="16" y2="35" />
                <line x1="32" y1="13" x2="32" y2="35" />
                <line x1="13.5" y1="24" x2="34.5" y2="24" />
              </g>
              <path d="M19 24a5 5 0 0 1 10 0" fill="none" stroke="currentColor" strokeWidth={3.2} strokeLinecap="round" />
            </svg>
