...
/** Approve prompts for the BFF-issued endpoint/credentials (coxwell whitelists manually at
 * BFF first, then pastes what they get back here) -- trial length is fixed server-side
 * (BLACK_TRIAL_DAYS), not an admin-entered value -- decline prompts for an optional reason
 * forwarded to the client's decline DM. */
