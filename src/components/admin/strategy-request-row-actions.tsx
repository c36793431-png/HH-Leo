...
import { STRATEGY_REQUEST_STATUSES, type StrategyRequestStatus } from "@/lib/strategy-requests";
import type { ActionResult } from "@/lib/action-result";
import { emitToast } from "@/lib/toast-bus";

type Action = (prevState: ActionResult | null, formData: FormData) => Promise<ActionResult>;

interface StrategyRequestRowActionsProps {
 ...
 * /admin/strategy-requests row — mirrors FeedRequestRowActions. */
export function StrategyRequestRowActions({
  strategyRequestId,
  status,
  notes,
  setStatusAction,
  setNotesAction,
}: StrategyRequestRowActionsProps) {
  ...
  function handleStatusChange(next: string) {
    ...
    formData.append("id", strategyRequestId);
