...
export type PanelKey = "portal" | "partner" | "feed";
 ...
 * member portal; partner/feed_provider each unlock one more. Admin is
 * deliberately excluded -- that surface already has its own host-switch
 * (PortalSidebar's admin-only toggle) and coxwell's standing ruling
 * (feed-admin-role-collision-fix-2026-08-24) is "admin has its own page, no
 * dual-role toggle". */
